...
public class FeedAdapter {
    ...
    public static Feed adaptToORM(fr.univrouen.rss22_project.model.feed.Feed feedXML){
        return new Feed(feedXML.getTitle(), feedXML.getPubDate());
    }
    public static Set<Item> getORMItems(fr.univrouen.rss22_project.model.feed.Feed feedXML,Feed feedORM){
