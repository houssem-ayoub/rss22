...
public class PersonAdapter {
    public static Person adaptToORM(fr.univrouen.rss22_project.model.xml.Person personXML){
        return new Person(
    ...
    public static Set<Person> adaptAllToORM(Set<fr.univrouen.rss22_project.model.xml.Person> personXMLSet){
